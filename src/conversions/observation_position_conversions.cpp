...
void to_ros_msg(
  ...
  romea_localisation_msgs::msg::ObservationPosition2D & msg)
{
  msg.position.x = observation.Y(core::localisation::ObservationPosition::POSITION_X);
  msg.position.y = observation.Y(core::localisation::ObservationPosition::POSITION_Y);
...
void extract_obs(
  ...
  core::localisation::ObservationPosition & observation)
{
  observation.Y(core::localisation::ObservationPosition::POSITION_X) =
    msg.observation_position.position.x;
  observation.Y(core::localisation::ObservationPosition::POSITION_Y) =
    msg.observation_position.position.y;
  observation.R() = Eigen::Matrix2d(msg.observation_position.position.covariance.data());
  observation.lever_arm.x() = msg.observation_position.lever_arm.x;
  observation.lever_arm.y() = msg.observation_position.lever_arm.y;
  observation.lever_arm.z() = msg.observation_position.lever_arm.z;
}
